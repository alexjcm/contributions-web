      ...
      <Dialog as="div" className="relative z-50" onClose={loading ? () => undefined : onCancel}>
        ...
        <div className="fixed inset-0 overflow-y-auto p-4 md:p-8">
          <div className="flex min-h-full items-center justify-center">
            ...
            >
              <DialogPanel className="w-full max-w-md overflow-hidden rounded-[1.75rem] border border-[color:var(--color-border)] bg-[linear-gradient(180deg,rgba(255,255,255,0.99),rgba(247,250,255,0.97))] shadow-[0_24px_60px_rgba(37,99,235,0.12)] transition-all">
                <div className="p-8">
                  <div className="flex items-start gap-4">
                    <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl shadow-sm ${
                      danger ? "border border-rose-300 bg-rose-100/70 text-rose-700" : "border border-primary-200 bg-primary-50/80 text-primary-700"
                    }`}>
